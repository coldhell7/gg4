...
class ResumesControllerTest < ActionController::TestCase
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post :create, resume: { edu: @resume.edu, exp: @resume.exp, full_name: @resume.full_name, skill: @resume.skill }
    end
  ...
  test "should update resume" do
    patch :update, id: @resume, resume: { edu: @resume.edu, exp: @resume.exp, full_name: @resume.full_name, skill: @resume.skill }
    assert_redirected_to resume_path(assigns(:resume))
  end
